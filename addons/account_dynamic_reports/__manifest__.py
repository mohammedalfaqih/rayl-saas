# -*- coding: utf-8 -*-
{
    ...
    'sequence': 15,
    'description': """
                    RAYL Full Accouning, RAYL All in one Accouning, PDF Reports, XLSX Reports,
                    Dynamic View, Drill down, Clickable, Pdf and Xlsx package, RAYL Accounting,
                    Full Account Reports, Complete Accounting Reports, Financial Report for RAYL,
