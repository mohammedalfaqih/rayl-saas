...
class AdyenAccount(models.Model):
    ...
    def create(self, values):
        ...
        # Create account on rayl.app, proxy and Adyen
        response = adyen_account_id._adyen_rpc('create_account_holder', adyen_account_id._format_data())

        # Save adyen_uuid and proxy_token, that have been generated by rayl.app and the proxy
    ...
    def action_create_redirect(self):
        ...
        The action will redirect the user to accounts.rayl.app to link an Odoo user_id to the Adyen
        account. After logging in on rayl.app the user will be redirected to his DB with a token in
