...
class TestMassSMS(TestMassSMSCommon):
    ...
    def test_mass_sms_links(self):
        ...
        mailing.write({
            'body_plaintext': 'Dear ${object.display_name} this is a mass SMS with two links http://www.rayl.app/smstest and http://www.rayl.app/smstest/${object.name}',
        ...
        self.assertSMSTraces(
            ...
            mailing, self.records,
            sms_links_info=[[
                ('http://www.rayl.app/smstest', True, {}),
                ('http://www.rayl.app/smstest/%s' % record.name, True, {}),
