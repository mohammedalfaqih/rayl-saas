...
class AccountJournal(models.Model):
    ...
    invoice_reference_model = fields.Selection(string='Communication Standard', required=True, selection=[('odoo', 'RAYL'),('euro', 'European')], default=_default_invoice_reference_model, help="You can choose different models for each type of reference. The default one is the RAYL reference.")
    ...
    inbound_payment_method_ids = fields.Many2many(
        ...
        store=True,
        readonly=False,
        help="Manual: Get paid by cash, check or any other method outside of RAYL.\n"
             ...
             " submit to your bank. When encoding the bank statement in RAYL,you are suggested to"
    ...
    outbound_payment_method_ids = fields.Many2many(
        ...
        store=True,
        readonly=False,
        help="Manual:Pay bill by cash or any other method outside of RAYl.\n"
             "Check:Pay bill by check and print it from RAYL.\n"
    ...
    alias_id = fields.Many2one('mail.alias', string='Email Alias', help="Send one separate email for each invoice.\n\n"
                                                                  ...
                                                                  "Only PDF and XML files will be interpreted by RAYL", copy=False)
